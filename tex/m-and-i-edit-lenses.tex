...
Given a Q-module $I$, $Q_I$ has subqueries if there is a function \\ $\dcirc : \sum\limits_{q \in Q_I} (I \rhd q \to Q_I) \to Q_I$ such that 
\begin{align*}
...
fce-lenses $k:A \leftrightarrow B$ and $l : B \leftrightarrow C$ can be composed whenever lifting is defined on their query languages, and the query languages have subqueries.
