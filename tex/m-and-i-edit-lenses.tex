...
\subsection{Model}
In the local setting when all the views are stored in the form of
Ideal from which all the necessary views can be derived by using the
functor.
...
where it is applied to $I$. This does not require propogating the
